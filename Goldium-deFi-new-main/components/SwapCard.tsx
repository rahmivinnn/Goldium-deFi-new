...
export default function SwapCard() {
  ...
  return (
    ...
    >
      ...
      <div className="relative super-premium-card backdrop-blur-xl border cyber-border bg-gradient-to-br from-slate-900/90 via-violet-900/15 to-slate-900/90 overflow-hidden rounded-2xl shadow-2xl border-amber-500/20">
        ...
        <div className="p-6 relative z-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <Dialog>
              ...
              <DialogContent className="super-premium-card backdrop-blur-xl border cyber-border bg-gradient-to-br from-gray-900/95 via-purple-900/30 to-gray-900/95">
