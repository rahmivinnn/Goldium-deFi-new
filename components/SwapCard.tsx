...
export default function SwapCard() {
  ...
  return (
    ...
    >
      <div className={`rounded-2xl border ${isDarkTheme ? "bg-gray-900/50 border-gray-800" : "bg-white/50 border-gray-200"} backdrop-blur-sm shadow-xl`}>
        <div className="p-6">
          ...
          >
            <Button 
              className="w-full mt-4 bg-gradient-to-r from-gold to-yellow-400 hover:from-gold/90 hover:to-yellow-400/90 text-black font-semibold" 
              onClick={handleSwap} 
              disabled={!canSwap}
            >
              {isLoading ? (
