...
export default function EggNFTShowcase() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-900 via-purple-900/50 to-gray-900 relative overflow-hidden">
      {/* Enhanced Background Effects */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-yellow-400/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-purple-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-pink-400/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-10 right-20 w-20 h-20 bg-blue-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '3s' }} />
        <div className="absolute bottom-10 left-20 w-24 h-24 bg-green-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-4xl font-bold text-white bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
              ...
              <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
                ...
                <div className="text-gold font-bold">{featuredEggs[currentEgg].price} GOLD</div>
              </div>
            </div>
